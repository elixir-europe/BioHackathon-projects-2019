from textminingservice.exporters.exporters import export_mentions_cytoscape
...
if __name__ == '__main__':
    entities = ["DOID:10652", "DOID:10935"]
    text_mining_services = [DummyService(), JensenLabService(), BioKBService()]
